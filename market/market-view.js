...
export default function ECMarketAdminView({itemState, appPrefs, onListLimitChange,
	onSearchChange, onSearchClick, onPaginationClick, onOrderBy,
	closeModal, onOption, inputChange, session}) {

	let columns = [];
	if (itemState.prefLabels != null && itemState.prefLabels.EC_MARKET_ADMIN_PAGE != null) {
		columns = itemState.prefLabels.EC_MARKET_ADMIN_PAGE;
	}
	let group = "TABLE1";
	
	let header = "";
	if (itemState.prefTexts.EC_MARKET_ADMIN_PAGE != null && itemState.prefTexts.EC_MARKET_ADMIN_PAGE.EC_MARKET_ADMIN_PAGE_HEADER != null) {
		header = itemState.prefTexts.EC_MARKET_ADMIN_PAGE.EC_MARKET_ADMIN_PAGE_HEADER.value;
	}
